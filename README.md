...
```bash
bash <(curl -fsSL https://github.com/likilu2002/sing-box-reality-hysteria2/raw/main/beta.sh)
```

### reality hysteria2二合一脚本

```bash
bash <(curl -fsSL https://github.com/likilu2002/sing-box-reality-hysteria2/raw/main/install.sh)
```
...
```bash
bash <(curl -fsSL https://github.com/likilu2002/sing-box-reality-hysteria2/raw/main/tcp-brutal-reality.sh)
```
### brutal reality vision reality hysteria2三合一(双端sing-box 1.7.0及以上可用)，warp分类，端口跳跃等功能

```bash
bash <(curl -fsSL https://github.com/likilu2002/sing-box-reality-hysteria2/raw/main/brutal-reality-hysteria.sh)
```
